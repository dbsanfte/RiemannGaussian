(function () {
  ...
  function render(fit = false) {
    ...
    for (const i of visible) {
      ...
      html += `</text><text class="node-meta" x="${p.x + 13}" y="${p.y + p.height - 10}">${terminal ? "TERMINAL THEOREM" : n.verifiedDataBoundary ? "GENERATED DATA BOUNDARY" : n.generated ? "GENERATED HELPER" : esc(n.kind.toUpperCase())}${count ? ` · ${count} project refs` : ""}</text>`;
