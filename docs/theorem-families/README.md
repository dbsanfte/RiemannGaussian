...
Browse all **1,890 Lean source modules** by mathematical family. Every listed module is reachable from a declared build target. Modules marked **optional certificate build** require `lake build NumericalCertificate --wfail`; ordinary builds exclude them.
...
| [Oscillatory sums](oscillation.md) | 106 | Finite differencing, derivative tests, dyadic blocks and uniform Dirichlet estimates. |
