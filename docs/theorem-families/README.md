...
Browse all **2,354 Lean source modules** by mathematical family. Every listed module is reachable from a declared build target. Modules marked **optional certificate build** require `lake build NumericalCertificate --wfail`; ordinary builds exclude them.
...
| [Oscillatory sums](oscillation.md) | 232 | Finite differencing, derivative tests, dyadic blocks and uniform Dirichlet estimates. |
